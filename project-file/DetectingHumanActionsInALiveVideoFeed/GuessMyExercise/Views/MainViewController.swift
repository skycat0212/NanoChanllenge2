...
class MainVC: MainViewController {
...
extension MainVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = ReactionTableViewCell() as ReactionTableViewCell
        
        switch indexPath.row {
        case 0, 5:
            cell.contentLabel.text = "Snoopy - agree"
        case 1, 6:
            cell.contentLabel.text = "Nick - add opinion"
        case 2, 7:
            cell.contentLabel.text = "Dake - thinking"
        case 3, 8:
            cell.contentLabel.text = "Duna - agree"
        case 4, 9:
            cell.contentLabel.text = "Skip - question"
        default:
